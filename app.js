...
const contents = {
  ...
  projects: () => `
    ...
    <p class="muted">
      ...
      from Control Center and appear
      here automatically.
      ...
      portfolio.achievements
        .map(
          achievement => `
            ...
            <div
              class="panel-card achievement-card"
            >
              ${esc(achievement)}
            </div>
  ...
  if (!state.adminSession) {
    ...
    return `
      ...
      <p class="muted">
        ...
        Only your authenticated account
        can publish changes.
...
function wireWindow(
  ...
  /*
    Event delegation inside window.
  */
...
/*
  IMPORTANT:
  ONE document-level delegated listener.

  This works even when buttons are dynamically
  recreated by renderAppGrid().
*/
...
async function loadRemote() {
  ...
  try {
    ...
    console.warn(
      'Remote load failed; using local content.',
      error
    );
...
/*
  ...
  The public portfolio should not wait for
  Supabase before buttons become available.
*/
...
/*
  Then check Supabase session/content.
*/
